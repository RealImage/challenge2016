...
func makeAddDistributorEndpoint(s Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := s.AddDistributor(ctx, req.ParentDistributorId, req.DistributorId, req.Permission, req.CountryCode, req.StateCode, req.CityCode)
		return addDistributorResponse{Err: err}, nil
	}
}

func (e Endpoints) AddDistributor(ctx context.Context, parentDistributorId domain.DistributorId, distributorId domain.DistributorId, permission domain.Permission, countryCode domain.CountryCode, stateCode domain.StateCode, cityCode domain.CityCode) (err error) {
