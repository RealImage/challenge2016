...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { email: @sample.email, name: @sample.name, ph: @sample.ph } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { email: @sample.email, name: @sample.name, ph: @sample.ph } }
